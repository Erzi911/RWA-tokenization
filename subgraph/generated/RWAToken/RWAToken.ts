...
export class RWAToken__checkpointsResultValue0Struct extends ethereum.Tuple {
  get _key(): BigInt {
...
export class RWAToken__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class RWAToken extends ethereum.SmartContract {
  ...
  checkpoints(
    account: Address,
    pos: BigInt,
  ): RWAToken__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<RWAToken__checkpointsResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt,
  ): ethereum.CallResult<RWAToken__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint48,uint208))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<RWAToken__checkpointsResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  eip712Domain(): RWAToken__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new RWAToken__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<RWAToken__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RWAToken__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
