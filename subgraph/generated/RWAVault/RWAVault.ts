...
export class RWAVault extends ethereum.SmartContract {
  ...
  depositsPaused(): boolean {
    let result = super.call("depositsPaused", "depositsPaused():(bool)", []);

    return result[0].toBoolean();
  }

  try_depositsPaused(): ethereum.CallResult<boolean> {
    let result = super.tryCall("depositsPaused", "depositsPaused():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class SetDepositsPausedCall extends ethereum.Call {
  get inputs(): SetDepositsPausedCall__Inputs {
    return new SetDepositsPausedCall__Inputs(this);
  }

  get outputs(): SetDepositsPausedCall__Outputs {
    return new SetDepositsPausedCall__Outputs(this);
  }
}

export class SetDepositsPausedCall__Inputs {
  _call: SetDepositsPausedCall;

  constructor(call: SetDepositsPausedCall) {
    this._call = call;
  }
...
export class SetDepositsPausedCall__Outputs {
  _call: SetDepositsPausedCall;
